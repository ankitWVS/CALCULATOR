...
btnequals = Button(cal,padx = 16, pady = 16, bd = 8, fg = 'white', font = ('arial', 20, 'bold'),
              text = '=', bg = 'black',command=btnEqualesInput).grid(row = 4,column = 2)
